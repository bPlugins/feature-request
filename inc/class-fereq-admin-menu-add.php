...
class Fereq_Admin_Menu_Page_Add
{
    ...
    public function fereq_admin_menu_page_add()
    {
        ...
        add_submenu_page(
            "features-request",
            __("Manage Request", "features-request"),
            __("Manage Request", "features-request"),
            "manage_options",
            "manage-Request",
    ...
    public function style_tab_color_settings_init() {
        ...
        register_setting('fereq_options_group', 'fereq_background_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
    
        register_setting('fereq_options_group', 'fereq_all_title_font_size', [
            'sanitize_callback' => 'absint'
        ]);
    
        register_setting('fereq_options_group', 'fereq_all_title_font_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
    
        register_setting('fereq_options_group', 'fereq_all_paragraph_font_size', [
            'sanitize_callback' => 'absint'
        ]);
    
        register_setting('fereq_options_group', 'fereq_all_paragraph_font_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
    
        register_setting('fereq_options_group', 'fereq_button_background_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
    
        register_setting('fereq_options_group', 'fereq_button_text_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
    
        register_setting('fereq_options_group', 'fereq_like_button_background_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
    
        register_setting('fereq_options_group', 'fereq_like_button_text_color', [
            'sanitize_callback' => 'sanitize_hex_color'
        ]);
        ...
        add_settings_field(
            ...
            __('Background Color', 'features-request'),
        ...
        add_settings_field(
            ...
            __('All title font size', 'features-request'),
        ...
        add_settings_field(
            ...
            __('All Title Color', 'features-request'),
        ...
        add_settings_field(
            ...
            __('All Paragraph font size', 'features-request'),
        ...
        add_settings_field(
            ...
            __('All Paragraph Color', 'features-request'),
        ...
        add_settings_field(
            ...
            __('Button Background Color', 'features-request'),
        ...
        add_settings_field(
            ...
            __('Button text Color', 'features-request'),
        ...
        add_settings_field(
            ...
            __('Like Button Background Color', 'features-request'),
        ...
        add_settings_field(
            ...
            __('Like Button text Color', 'features-request'),
        ...
        <div class="wrap">
            ...
            <div class="working_div">
                <div class="work">
                    ...
                    <h4>Add the shortcode [fereq_features-request] on the new page or whichever page you’d like to display it.</h4>
                </div>
                <div class="work">
...
//phpcs:ignore WordPress.DB.PreparedSQL.InterpolatedNotPrepared
    ...
    public function report_status_update_action_handler()
    {
        ...
        $update_status_select = isset($_POST['update_status_select']) ? sanitize_text_field(wp_unslash($_POST['update_status_select'])) : "";
    ...
    public function edit_plugin_name_to_database_handler()
    {
        ...
        $table_name = esc_sql($this->plugin_add); 

        $query = $wpdb->prepare("SELECT * FROM {$table_name} WHERE plugin_id = %d", $plugin_id);
        $plugin_data = $wpdb->get_results($query);
    ...
    public function edit_plugin_name_save_to_database_handler()
    {
        ...
        $edited_plugin_name = isset($_POST['edited_plugin_name']) ? sanitize_text_field(wp_unslash($_POST['edited_plugin_name'])) : "";
